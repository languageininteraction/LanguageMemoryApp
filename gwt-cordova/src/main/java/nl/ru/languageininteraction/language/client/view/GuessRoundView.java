...
public class GuessRoundView extends AbstractSvgView {
    ...
    protected void getSvg(SafeHtmlBuilder builder) {
        ...
        matchLanguageBuilder.getSvgBackground(builder, SvgTemplate.Visibility.visible);
...
//        matchLanguageBuilder.getSvgIncorrectButton(builder, SvgTemplate.Visibility.hidden);
        ...
        matchLanguageBuilder.getSvgMap(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgPins(builder, SvgTemplate.Visibility.visible);
        ...
        matchLanguageBuilder.getSvgCorrectButton1(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgCorrectButton2(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgCorrectButton3(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgCorrectButton4(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgCorrectButton5(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgIncorrectButton1(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgIncorrectButton2(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgIncorrectButton3(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgIncorrectButton4(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgIncorrectButton5(builder, SvgTemplate.Visibility.visible);
        ...
        matchLanguageBuilder.getSvgMapBackground(builder, SvgTemplate.Visibility.visible);
        matchLanguageBuilder.getSvgDobesSymbol(builder, SvgTemplate.Visibility.visible);
    }
